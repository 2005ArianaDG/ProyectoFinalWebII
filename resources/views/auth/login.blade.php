                    ...
                    <div class="card border border-light-subtle rounded-3 shadow-sm mt-5">
                        <div class="card-body p-3 p-md-4 p-xl-5">
                            <div class="text-center mb-3">
                                <a href="{{ route('home') }}">
                                    <img src="storage/img/logo1.png" width="200">
                                </a>
                            </div>
                                ...
                                <div class="row gy-2 overflow-hidden">
                                    ...
                                    <div class="col-12">
                                        <div class="d-flex gap-2 justify-content-between">
                                            ...
                                            <a href="{{ route('formulario-recuperacion-contrasenia') }}"class="link-primary text-decoration-none">{{ __('¿Has olvidado tu contraseña?') }}</a>
                                        </div>
                                    </div>
                                    <div class="col-12">
